			...
			sidebar: [
				...
				{ label: 'The UpDoc API', slug: 'api' },
				{
					...
					items: [
						...
						{ label: 'Why UpDoc Needed an API', slug: 'mcp/why-an-api' },
						{ label: 'Routes Considered', slug: 'mcp/routes-considered' },
						{ label: 'Making the API Visible', slug: 'mcp/making-the-api-visible' },
						{ label: 'Describing the Responses', slug: 'mcp/describing-responses' },
						{ label: 'Porting the Mapping to C#', slug: 'mcp/porting-to-csharp' },
						{ label: 'Two Implementations', slug: 'mcp/two-implementations' },
						{ label: 'Building the Tools', slug: 'mcp/building-the-tools' },
						{ label: 'Chaining', slug: 'mcp/chaining' },
						{ label: 'Testing Traps', slug: 'mcp/testing-traps' },
						{ label: 'Publishing to npm', slug: 'mcp/publishing' },
						{ label: 'What Is Still Open', slug: 'mcp/still-open' },
					],
				},
				{
