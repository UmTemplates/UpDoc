const o = [
  ...
  // =====================================================================
  {
    ...
    weight: 1100,
    api: () => import("./up-doc-action-CBa41gkb.js"),
  ...
  // =====================================================================
  {
    ...
    api: () => import("./up-doc-has-workflows.condition-BDQK00-4.js")
  },
  // =====================================================================
  ...
  // =====================================================================
  {
    ...
    element: () => import("./up-doc-collection-action.element-CM5EdyWA.js"),
    weight: 50,
    meta: {
  ...
  // =====================================================================
  {
    ...
    alias: "UpDoc.Modal",
    name: "UpDoc Modal",
    element: () => import("./up-doc-modal.element-D3X7qNkR.js")
  },
  {
    type: "modal",
  ...
  },
  {
    ...
    element: () => import("./create-workflow-sidebar.element-DCmQl2ks.js")
  },
  {
    type: "modal",
    alias: "UpDoc.WorkflowDetailModal",
    name: "Workflow Detail Modal",
    element: () => import("./up-doc-workflow-detail-modal.element-D5umD2A6.js")
  },
  {
    type: "modal",
    alias: "UpDoc.DestinationPickerModal",
    name: "Destination Picker Modal",
    element: () => import("./destination-picker-modal.element-Dp9c2s9K.js")
  },
  {
    type: "modal",
    alias: "UpDoc.AreaEditorModal",
    name: "Area Editor Modal",
    element: () => import("./pdf-area-editor-modal.element-J9y7wHbr.js")
  },
  {
    type: "modal",
    alias: "UpDoc.AreaPickerModal",
    name: "Area Picker Modal",
    element: () => import("./area-picker-modal.element-BcSPcfkx.js")
  },
  {
    type: "modal",
  ...
  },
  {
    ...
    element: () => import("./section-rules-editor-modal.element-BggEEBgj.js")
  },
  {
    type: "modal",
    alias: "UpDoc.SortModal",
    name: "Sort Modal",
    element: () => import("./up-doc-sort-modal.element-i7DaPusf.js")
  },
  // =====================================================================
  ...
  },
  {
    ...
    name: "Destination",
    element: () => import("./up-doc-workflow-destination-view.element-CBgv6QuZ.js"),
    weight: 300,
    meta: {
      label: "Destination",
  ...
  },
  {
    ...
    element: () => import("./up-doc-workflow-source-view.element-DdmmYvgE.js"),
    weight: 200,
    meta: {
      label: "Source",
      pathname: "source",
  ...
  },
  {
    ...
    element: () => import("./up-doc-workflow-map-view.element--Bu1AuJJ.js"),
    weight: 100,
    meta: {
      label: "Map",
      pathname: "map",
  ...
  // =====================================================================
  {
    ...
    name: "Workflows",
    element: () => import("./up-doc-workflows-view.element-Bk4NJEWb.js"),
    weight: 300,
    meta: {
      label: "Workflows",
      pathname: "workflows",
  ...
  },
  {
    ...
    name: "About",
    element: () => import("./up-doc-about-view.element-Cam2Mm3Y.js"),
    weight: 100,
    meta: {
      label: "About",
      pathname: "about",
